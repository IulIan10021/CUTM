      ...
      <div className="bg-utm-blue text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-blue-200 text-sm mb-2">
            <Link href="/" className="hover:text-white">Acasă</Link> / <Link href="/proces-studii" className="hover:text-white">Proces de Studii</Link> / Orar
          </p>
          <h1 className="text-4xl font-black font-display">Orar</h1>
        </div>
      </div>
