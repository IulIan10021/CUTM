    ...
    <footer className="bg-utm-blue text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
              <span className="text-utm-blue font-bold text-sm font-display">UTM</span>
            </div>
            <div>
              <p className="font-bold font-display">UTM</p>
              <p className="text-blue-200 text-sm">Universitatea Tehnică a Moldovei</p>
              <p className="text-blue-200 text-xs mt-0.5">Str. Studențilori 9/9, Chișinău, Moldova</p>
            </div>
          </div>
          ...
          <div className="flex gap-6 text-sm text-blue-200">
            ...
            <Link href="/specialitati" className="hover:text-white transition-colors">Specialități</Link>
        ...
        <div className="border-t border-white/10 mt-8 pt-6 text-center text-blue-200 text-sm">
          <p>© {new Date().getFullYear()} Universitatea Tehnică a Moldovei. Toate drepturile rezervate.</p>
        </div>
      </div>
    </footer>
  )
